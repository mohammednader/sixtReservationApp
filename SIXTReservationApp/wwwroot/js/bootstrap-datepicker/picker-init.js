...
AGMPOP = {
    ...
    initFormExtendedDatetimepickers: function () {
        ...
        $(".birthdate-picker").datetimepicker({
            ...
            format: 'DD/MM/YYYY',   //use this format if you want the 12hours timpiecker with AM/PM toggle.
            maxDate: new Date(),
            //defaultDate: new Date(new Date().AddYear(-20).getFullYear(), 0, 1),
            viewMode: 'years',
            showClear: true,
            showClose: true,
            icons: {
        ...
        $(".visit-datepicker").datetimepicker({
            useCurrent: false,
            format: 'DD/MM/YYYY',   //use this format if you want the 12hours timpiecker with AM/PM toggle.
            minDate: new Date().StartDay(),
            maxDate: new Date().AddDay(2).EndDay(),
            //defaultDate: new Date(new Date().AddYear(-20).getFullYear(), 0, 1),
            viewMode: 'days',
            showClear: true,
            showClose: true,
