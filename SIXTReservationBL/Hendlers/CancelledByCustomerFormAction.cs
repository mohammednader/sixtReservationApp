...
{
    public class CancelledByCustomerFormAction : SixtReservationHandler<FormActionVM>, IBuilder
    {
        public CancelledByCustomerFormAction(int currentStep, long reservationNo, int reservationStatus,int savedLoggedId, IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        public override bool PerformAction(FormActionVM request)
        {
            ...
            var LastNotifications = unitOfWork.NotificationBL.Find(n =>
                                                                ...
                                                                (n.GroupId == (int)NotificationGroupType.NoFormSubmitNotification || n.GroupId == (int)NotificationGroupType.AssignedToMe))
                                                                    .ToArray();
