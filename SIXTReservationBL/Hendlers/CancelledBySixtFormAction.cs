...
{
    public class CancelledBySixtFormAction : SixtReservationHandler<FormActionVM>, IBuilder
    {
        public CancelledBySixtFormAction(int currentStep, long reservationNo, int reservationStatus,int savedLoggedId, IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        public override bool PerformAction(FormActionVM request)
        {
            ...
            var LastNotifications = unitOfWork.NotificationBL.Find(n =>
                                                                ...
                                                                (n.GroupId == (int)NotificationGroupType.NoFormSubmitNotificationCBySixt || n.GroupId == (int)NotificationGroupType.AssignedToMeCBySixt))
                                                                    .ToArray();
